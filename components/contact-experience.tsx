...
export function ContactExperience() {
  ...
  return <section className="contact-experience shell" aria-labelledby="contact-router-title">
    ...
    <div id="enquiry-form" className="contact-form-panel"><div><p className="eyebrow">{category.toUpperCase()}</p><h2>Tell us what you need.</h2><p>The form is sent through Kravia’s controlled corporate intake. It will not create a public post or expose your details.</p></div><EnquiryForm initialCategory={category} /></div>
  </section>;
}
