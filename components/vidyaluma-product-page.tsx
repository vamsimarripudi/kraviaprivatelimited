...
export function VidyaLumaProductPage() {
  return <main id="main-content" className="vidyaluma-page">
    ...
    <section className="vidyaluma-section vidyaluma-intelligence" aria-labelledby="vidyaluma-intelligence-title">
      <div className="shell vidyaluma-intelligence-grid"><BrainCircuit aria-hidden="true" /><div><p className="eyebrow">04 / AI-ASSISTED INTELLIGENCE</p><h2 id="vidyaluma-intelligence-title">Intelligence with <em>human judgement intact.</em></h2><p>VidyaLuma is designed to support analysis, learning intelligence, evaluation workflows, reporting and operational insight. It does not replace teachers, school leadership or authorised human decision-making.</p><p>Automation should make the next responsible action clearer—not hide who is accountable.</p></div></div>
    </section>

    <section className="vidyaluma-section shell vidyaluma-trust" aria-labelledby="vidyaluma-trust-title">
      <header className="vidyaluma-section-head"><div><p className="eyebrow">05 / GOVERNED FOUNDATION</p><h2 id="vidyaluma-trust-title">A product architecture that keeps the school context <em>in view.</em></h2></div></header>
    ...
    <section className="vidyaluma-section shell vidyaluma-faq" aria-labelledby="vidyaluma-faq-title"><header className="vidyaluma-section-head"><div><p className="eyebrow">06 / FAQ</p><h2 id="vidyaluma-faq-title">A clear product boundary.</h2></div></header><Accordion label="VidyaLuma frequently asked questions" entries={vidyaLumaProduct.faqs.map(([title, content]) => ({ title, content: <p>{content}</p> }))} /></section>
  </main>;
}