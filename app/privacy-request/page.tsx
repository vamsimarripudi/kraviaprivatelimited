...
export default function PrivacyRequest() { return <><SiteNav /><main id="main-content"><PageHero eyebrow="Privacy request" title="A private route for your request." intro="Submit a privacy question, rights request, grievance or security concern. Your request is not public." /><section className="shell form-section"><TrustRequestPortal /></section></main><Footer /></>; }
