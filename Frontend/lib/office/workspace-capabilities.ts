...
const requirements: Record<string, readonly string[]> = {
  ...
  "office:products": ["master.product.read", "master.product.create", "product.roadmap.read", "product.roadmap.write", "product.release.request", "product.release.approve"],
  "office:customers": ["master.customer.read", "master.customer.create"],
  ...
  "office:budget": ["finance.budget.read", "finance.budget.commit"],
  ...
  "office:documents": ["document.template.read", "document.template.manage", "document.template.publish", "document.instance.read", "document.instance.review", "document.render", "document.signature.record", "document.delivery.record", "document.hr.create", "document.secretarial.create", "document.legal.create", "document.sales.create", "document.operations.create"],
  ...
  "finance:documents": ["finance.read", "document.template.read", "document.instance.read", "document.instance.review", "document.render", "document.signature.record", "document.delivery.record", "document.finance.create"],
