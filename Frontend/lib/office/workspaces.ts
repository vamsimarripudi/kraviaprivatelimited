...
export const officeSections = {
  ...
  decisions: { title: "Executive decisions", eyebrow: "EXECUTIVE ACTION", description: "Controlled reviews, reserved approvals and decision queues assigned to executive authority.", roles: executive, group: "Lead" },
  ...
  security: { title: "Security", eyebrow: "SECURITY OBSERVABILITY", description: "Authentication, device, access and incident evidence requires explicit security capability; access administrators do not inherit security authority automatically.", roles: officeWorkspaceRoles, group: "Assure" },
