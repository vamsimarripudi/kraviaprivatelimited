...
export const officeSections = {
  ...
  registrations: { title: "Registrations", eyebrow: "COMPANY REGISTRY", description: "Masked company registration references, renewal dates, authoritative source/evidence links and independent verification history.", roles: compliance, group: "Govern" },
  ...
  audit: { title: "Audit trail", eyebrow: "APPEND-ORIENTED EVIDENCE", description: "Office control-plane events plus canonical runtime audit evidence, with runtime cryptographic chain verification kept explicitly source-scoped.", roles: ["OWNER", "DIRECTOR", "CS", "LEGAL", "AUDITOR"], group: "Assure" },
...
export const financeSections = {
  ...
  expenses: { title: "Expenses", eyebrow: "COMPANY SPEND", description: "Company obligations with evidence, explicit funding mode and maker-checker approval; shareholder contributions fund spend without changing legal ownership.", roles: financeWrite, group: "Treasury" },
