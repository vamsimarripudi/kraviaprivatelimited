...
export default async function AdminDashboardPage() {
  ...
  return <section className="admin-page">
    ...
    <section className="admin-signal-grid" aria-label="Current website operations">
      ...
      <article><ShieldCheck aria-hidden="true" /><p className="eyebrow">REVIEW QUEUE</p><strong>{reviewResult.count ?? "—"}</strong><span>{reviewResult.count === null ? "restricted to your role" : "content record(s) awaiting review"}</span><Link href="/admin/newsroom">Open review workflow <ArrowUpRight /></Link></article>
    </section>
