  ...
  >
    {value.length >= 64
      ...
      : <div style={{display:"flex",flexDirection:"column",gap:16,fontFamily:'Inter,"Segoe UI",sans-serif'}}>
          <div style={{width:46,height:46,borderRadius:14,display:"grid",placeItems:"center",background:"#f4eee5",color:"#8a5e1e",border:"1px solid #eadbc4"}}><KeyRound size={20}/></div>
          <p style={{margin:0,fontSize:11,color:"#68716d",lineHeight:1.6}}>This recovery URL is missing its private token. Ask an authorised Office administrator to issue a new recovery link.</p>
          <Link href="/office/recover" style={{color:"#225c46",fontWeight:700,textDecoration:"none"}}>Recovery instructions</Link>
        </div>}
  </OfficeAuthLayout>;
}
