        ...
        <div style={{ display: "grid", gap: 9 }}>
          ...
          {androidUrl ? (
            ...
            <div style={{ padding: 12, borderRadius: 12, background: "#f6f1e8", border: "1px solid #eadfc9", color: "#735a2e", fontSize: 11, lineHeight: 1.55 }}>
              Android internal APK is produced by KRAVIA CI. Obtain the currently approved pilot package from an authorised KRAVIA administrator. No public APK URL is exposed until a stable company-controlled distribution channel is approved.
            </div>
          )}
          {iosUrl ? (
            ...
            <div style={{ padding: 12, borderRadius: 12, background: "#f5f3ee", border: "1px solid #e7e0d5", color: "#6d6659", fontSize: 11, lineHeight: 1.55 }}>
              iPhone source/build configuration is ready. Employee installation waits for an approved Apple signing, TestFlight/App Store, or company MDM channel.
            </div>
          )}
        </div>
