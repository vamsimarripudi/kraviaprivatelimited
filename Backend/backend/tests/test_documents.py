...
def test_invoice_and_receipt_pdf_render():
    with TestClient(app) as c:
        ...
        inv=c.post('/api/v1/invoices',headers=H|{'Idempotency-Key':'doc-inv'},json={'customer_id':cust['id'],'product_id':prod['id'],'description':'VFormix subscription','sac':'998319','taxable_value':'1000','gst_rate':'18'}).json()
