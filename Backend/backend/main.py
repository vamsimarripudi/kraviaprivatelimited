...
def _runtime_operations_snapshot(db: Session) -> dict:
    ...
    persisted_interval = heartbeat.configured_interval_seconds if heartbeat and heartbeat.configured_interval_seconds else None
    worker_interval = persisted_interval or _integer_env("KRAVIA_WORKER_INTERVAL_SECONDS", 60)
